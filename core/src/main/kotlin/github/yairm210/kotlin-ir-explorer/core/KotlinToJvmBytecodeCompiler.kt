    /*
 *  NOTICE: Taken DIRECTLY from org.jetbrains.kotlin.cli.jvm.compiler 2.0.0 and MODIFIED
...
object KotlinToJVMBytecodeCompiler {
    ...
    fun runFrontendAndGenerateIrForMultiModuleChunkUsingFrontendIR(
        environment: KotlinCoreEnvironment,
        projectEnvironment: VfsBasedProjectEnvironment,
        compilerConfiguration: CompilerConfiguration,
        chunk: List<Module>,
        sourceFiles: List<KtFile> = environment.getSourceFiles(),
    ...
    fun runFrontendAndGenerateIrUsingClassicFrontend(
        environment: KotlinCoreEnvironment,
        compilerConfiguration: CompilerConfiguration,
        chunk: List<Module>
    ): BackendInputForMultiModuleChunk? {
    ...
    data class BackendInputForMultiModuleChunk(
    ...
    fun convertToIr(environment: KotlinCoreEnvironment, result: AnalysisResult): Pair<CodegenFactory, CodegenFactory.BackendInput> {
        val configuration = environment.configuration
        val codegenFactory =
    ...
    fun analyze(environment: KotlinCoreEnvironment, sourceFiles: List<KtFile> = environment.getSourceFiles()): AnalysisResult? {
